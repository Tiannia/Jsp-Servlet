(function (a) {
    a.flexslider = function (o, t) {
        var b = a(o), d = a.extend({}, a.flexslider.defaults, t), g = d.namespace,
            y = "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch,
            z = y ? "touchend" : "click", u = "vertical" === d.direction, v = d.reverse, n = 0 < d.itemWidth,
            x = "fade" === d.animation, w = "" !== d.asNavFor, j = {};
        ...
        j = {
            init: function () {
                ...
                setup: function () {
                    ...
                    var c = 1, e;
                    b.controlNavScaffold = a('<ol class="' + g + "control-nav " + g + ("thumbnails" === d.controlNav ? "control-thumbs" : "control-paging") + '"></ol>');
                    if (1 < b.pagingCount) {
                    ...
                    b.controlNavScaffold.delegate("a, img", z, function (h) {
                        h.preventDefault();
                        var h = a(this), i = b.controlNav.index(h);
                        h.hasClass(g + "active") || (b.direction = i > b.currentSlide ? "next" : "prev", b.flexAnimate(i, d.pauseOnAction))
                    });
                    ...
                    b.controlNav.live(z, function (c) {
                        c.preventDefault();
                        var c = a(this), e = b.controlNav.index(c);
                        c.hasClass(g + "active") || (e > b.currentSlide ? b.direction = "next" : b.direction = "prev", b.flexAnimate(e, d.pauseOnAction))
                    });
                    y && b.controlNav.live("click touchstart", function (c) {
                        c.preventDefault()
                    })
                }, set: function () {
                    b.controlNav = a("." + g + "control-nav li " + ("thumbnails" === d.controlNav ? "img" : "a"), b.controlsContainer ? b.controlsContainer : b)
                }, active: function () {
                    ...
                    j.controlNav.set();
                    1 < b.pagingCount && b.pagingCount !== b.controlNav.length ? b.update(f, e) : j.controlNav.active()
                }
            }, directionNav: {
                setup: function () {
                    var c = a('<ul class="' + g + 'direction-nav"><li><a class="' + g + 'prev" href="#">' + d.prevText + '</a></li><li><a class="' + g + 'next" href="#">' + d.nextText + "</a></li></ul>");
                    b.controlsContainer ? (a(b.controlsContainer).append(c), b.directionNav = a("." + g + "direction-nav li a", b.controlsContainer)) : (b.append(c), b.directionNav = a("." + g + "direction-nav li a", b));
                    j.directionNav.update();
                    b.directionNav.bind(z, function (e) {
                        e.preventDefault();
                        e = a(this).hasClass(g + "next") ? b.getTarget("next") : b.getTarget("prev");
                        b.flexAnimate(e, d.pauseOnAction)
                    });
                    ...
                    var c = g + "disabled";
                    1 === b.pagingCount ? b.directionNav.addClass(c) : d.animationLoop ? b.directionNav.removeClass(c) : 0 === b.animatingTo ? b.directionNav.removeClass(c).filter("." + g + "prev").addClass(c) : b.animatingTo === b.last ? b.directionNav.removeClass(c).filter("." + g + "next").addClass(c) : b.directionNav.removeClass(c)
                }
            }, pausePlay: {
                setup: function () {
                    var c = a('<div class="' + g + 'pauseplay"><a></a></div>');
                    b.controlsContainer ? (b.controlsContainer.append(c), b.pausePlay = a("." + g + "pauseplay a", b.controlsContainer)) : (b.append(c), b.pausePlay = a("." + g + "pauseplay a", b));
                    ...
                    "play" === c ? b.pausePlay.removeClass(g + "pause").addClass(g + "play").text(d.playText) : b.pausePlay.removeClass(g + "play").addClass(g + "pause").text(d.pauseText)
                }
            }, touch: function () {
                function c(e) {
                    q = u ? h - e.touches[0].pageY : h - e.touches[0].pageX;
                    A = u ? Math.abs(q) < Math.abs(e.touches[0].pageX - i) : Math.abs(q) < Math.abs(e.touches[0].pageY - i);
                    if (!A || 500 < Number(new Date) - r) {
                        e.preventDefault(), !x && b.transitions && (d.animationLoop || (q /= 0 === b.currentSlide && 0 > q || b.currentSlide === b.last && 0 < q ? Math.abs(q) / s + 2 : 1), b.setProps(l + q, "setTouch"))
                    }
                }

                function m() {
                    if (b.animatingTo === b.currentSlide && !A && null !== q) {
                        var e = v ? -q : q, f = 0 < e ? b.getTarget("next") : b.getTarget("prev");
                ...
                o.addEventListener("touchstart", function (e) {
                    b.animating ? e.preventDefault() : 1 === e.touches.length && (b.pause(), s = u ? b.h : b.w, r = Number(new Date), l = n && v && b.animatingTo === b.last ? 0 : n && v ? b.limit - (b.itemW + d.itemMargin) * b.move * b.animatingTo : n && b.currentSlide === b.last ? b.limit : n ? (b.itemW + d.itemMargin) * b.move * b.currentSlide : v ? (b.last - b.currentSlide + b.cloneOffset) * s : (b.currentSlide + b.cloneOffset) * s, h = u ? e.touches[0].pageY : e.touches[0].pageX, i = u ? e.touches[0].pageX : e.touches[0].pageY, o.addEventListener("touchmove", c, !1), o.addEventListener("touchend", m, !1))
                }, !1)
            }, resize: function () {
                !b.animating && b.is(":visible") && (n || b.doMath(), x ? j.smoothHeight() : n ? (b.slides.width(b.computedW), b.update(b.pagingCount), b.setProps()) : u ? (b.viewport.height(b.h), b.setProps(b.h, "setTotal")) : (d.smoothHeight && j.smoothHeight(), b.newSlides.width(b.computedW), b.setProps(b.computedW, "setTotal")))
            }, smoothHeight: function (e) {
                if (!u || x) {
                    var f = x ? b : b.viewport;
                    e ? f.animate({height: b.slides.eq(b.animatingTo).height()}, e) : f.height(b.slides.eq(b.animatingTo).height())
                }
            }, sync: function (c) {
                var h = a(d.sync).data("flexslider"), f = b.animatingTo;
                switch (c) {
                    case"animate":
            ...
            if (!b.animating && (b.canAdvance(c, h) || l) && b.is(":visible")) {
                if (w && f) {
                    if (l = a(d.asNavFor).data("flexslider"), b.atEnd = 0 === c || c === b.count - 1, l.flexAnimate(c, !0, !1, !0, h), b.direction = b.currentItem < c ? "next" : "prev", l.direction = b.direction, Math.ceil((c + 1) / b.visible) - 1 !== b.currentSlide && 0 !== c) {
                        b.currentItem = c, b.slides.removeClass(g + "active-slide").eq(c).addClass(g + "active-slide"), c = Math.floor(c / b.visible)
                    } else {
                        return b.currentItem = c, b.slides.removeClass(g + "active-slide").eq(c).addClass(g + "active-slide"), !1
                    }
                }
                b.animating = !0;
                b.animatingTo = c;
        ...
        b.wrapup = function (c) {
            !x && !n && (0 === b.currentSlide && b.animatingTo === b.last && d.animationLoop ? b.setProps(c, "jumpEnd") : b.currentSlide === b.last && (0 === b.animatingTo && d.animationLoop) && b.setProps(c, "jumpStart"));
            b.animating = !1;
        ...
        b.canAdvance = function (c, f) {
            ...
            return f ? !0 : w && b.currentItem === b.count - 1 && 0 === c && "prev" === b.direction ? !0 : w && 0 === b.currentItem && c === b.pagingCount - 1 && "next" !== b.direction ? !1 : c === b.currentSlide && !w ? !1 : d.animationLoop ? !0 : b.atEnd && 0 === b.currentSlide && c === e && "next" !== b.direction ? !1 : b.atEnd && b.currentSlide === e && 0 === c && "next" === b.direction ? !1 : !0
        };
        ...
        b.setProps = function (c, l, h) {
            ...
            i = -1 * function () {
                if (n) {
                    return "setTouch" === l ? c : v && b.animatingTo === b.last ? 0 : v ? b.limit - (b.itemW + d.itemMargin) * b.move * b.animatingTo : b.animatingTo === b.last ? b.limit : k
                }
                switch (l) {
                    case"setTotal":
                        return v ? (b.count - 1 - b.currentSlide + b.cloneOffset) * c : (b.currentSlide + b.cloneOffset) * c;
                    case"setTouch":
                        return c;
                    case"jumpEnd":
            ...
            b.transitions && (i = u ? "translate3d(0," + i + ",0)" : "translate3d(" + i + ",0,0)", h = void 0 !== h ? h / 1000 + "s" : "0s", b.container.css("-" + b.pfx + "-transition-duration", h));
            b.args[b.prop] = i;
        ...
        b.setup = function (c) {
            if (x) {
                b.slides.css({
                    ...
                    marginRight: "-100%",
                    position: "relative"
                }), "init" === c && b.slides.eq(b.currentSlide).fadeIn(d.animationSpeed, d.easing), d.smoothHeight && j.smoothHeight()
            } else {
                var e, f;
                "init" === c && (b.viewport = a('<div class="' + g + 'viewport"></div>').css({
                    overflow: "hidden",
                    position: "relative"
                }).appendTo(b).append(b.container), b.cloneCount = 0, b.cloneOffset = 0, v && (f = a.makeArray(b.slides).reverse(), b.slides = a(f), b.container.empty().append(b.slides)));
                d.animationLoop && !n && (b.cloneCount = 2, b.cloneOffset = 1, "init" !== c && b.container.find(".clone").remove(), b.container.append(b.slides.first().clone().addClass("clone")).prepend(b.slides.last().clone().addClass("clone")));
                b.newSlides = a(d.selector, b);
                e = v ? b.count - 1 - b.currentSlide + b.cloneOffset : b.currentSlide + b.cloneOffset;
                u && !n ? (b.container.height(200 * (b.count + b.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function () {
            ...
            if (d.controlNav && !b.manualControls) {
                if ("add" === e && !n || b.pagingCount > b.controlNav.length) {
                    ...
                    if ("remove" === e && !n || b.pagingCount < b.controlNav.length) {
                        n && b.currentSlide > b.last && (b.currentSlide -= 1, b.animatingTo -= 1), j.controlNav.update("remove", b.last)
                    }
                }
            }
            d.directionNav && j.directionNav.update()
        ...
        b.addSlide = function (c, h) {
            ...
            b.count += 1;
            b.last = b.count - 1;
            u && v ? void 0 !== h ? b.slides.eq(b.count - h).after(i) : b.container.prepend(i) : void 0 !== h ? b.slides.eq(h).before(i) : b.container.append(i);
            b.update(h, "add");
        ...
        b.removeSlide = function (c) {
            ...
            b.count -= 1;
            b.last = b.count - 1;
            isNaN(c) ? a(c, b.slides).remove() : u && v ? b.slides.eq(b.last).remove() : b.slides.eq(c).remove();
            b.doMath();
            b.update(f, "remove");
            b.slides = a(d.selector + ":not(.clone)", b);
            b.setup();
    ...
    a.fn.flexslider = function (b) {
        ...
        if ("object" === typeof b) {
            return this.each(function () {
                var d = a(this), e = d.find(b.selector ? b.selector : ".slides > li");

        ...
        <form action="/book_mall/manage/admin_douserdel" id="myform" method="post">
            <div class="result-title">
                <div class="result-list">
                    <a href="/book_mall/manage/tocateadd"><i class="icon-font"></i>新增分类</a>
                    ...
                    <c:forEach var="cate" items="${catelist}">
                        <c:if test="${cate.CATE_PARENT_ID == 0 }">
                            <tr>
                                ...
                                <td><a href="admin_tocateupdate?id=${cate.CATE_ID }">修改</a>
                            ...
                            <c:forEach var="zcate" items="${catelist}">
                                <c:if test="${zcate.CATE_PARENT_ID == cate.CATE_ID }">
                                    <tr>
                                        ...
                                        <td><a href="admin_tocateupdate?id=${zcate.CATE_ID }">修改</a>

...
<div class="main-wrap">
    ...
    <div class="search-wrap">
        <div class="search-content">
            <form action="/book_mall/manage/admin_douserselect" method="get">
    ...
    <div class="result-wrap">
        <form action="/book_mall/manage/admin_douserdel" id="myform" method="post">
            <div class="result-title">
                <div class="result-list">
                    <a href="/book_mall/manger/admin_useradd.jsp"><i class="icon-font"></i>新增用户</a>
                    <a id="batchDel" href="javascript:delmore('你确定删除这些用户吗？', 'myform')"><i
            ...
            <div class="result-content">
                <table class="result-tab" width="100%">
                    <tr>
                        <th class="tc" width="5%"><input class="allChoose" name="" onclick="delall(this)"
                                                         type="checkbox"></th>
                    ...
                    <c:forEach var="u" items="${userlist }">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="link-update"
                                   href="/book_mall/manage/admin_touserupdate?id=${u.USER_ID}&cpage=${cpage}">修改</a>
                                <c:if test="${u.USER_STATUS == 1 }">
                                    <a class="link-del"
                                       href="javascript:Delete('你确定要删除用户【${u.USER_NAME}】吗？','/book_mall/manage/admin_douserdel?id=${u.USER_ID}&cpage=${cpage}')">删除</a>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>

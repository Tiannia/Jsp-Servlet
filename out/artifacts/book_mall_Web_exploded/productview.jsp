...
<div class="address">
    <div class="wrapper clearfix">
        ...
        <a href="#" class="on">【精选】${p.PRODUCT_NAME }</a>
    </div>
</div><!-----------------------Detail------------------------------>
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            ...
            <div class="fr intro">
                <div class="title"><h4>【精选】${p.PRODUCT_NAME }</h4>
                    <p>【${p.PRODUCT_DESCRIPTION }】</p><span>￥${p.PRODUCT_PRICE }.00</span></div>
                <div class="proIntro"><p>分类：</p>
                    <div class="smallImg clearfix categ"><p class="fl on"><img src="images/product/${p.PRODUCT_FILENAME } "
                                                                            alt="${p.PRODUCT_NAME}"

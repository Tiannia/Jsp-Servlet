...
import com.tian.entity.LMONKEY_CART;
...
public class LMONKEY_CARTDao {
        ...
        try {
            ...
            while (rs.next()) {
                LMONKEY_CART c = new LMONKEY_CART(
                        ...
                        rs.getString("cart_p_name"),
                        rs.getInt("cart_p_price"),
                        rs.getInt("cart_quantity"), //数量
                        rs.getInt("cart_p_stock"),
                        rs.getInt("cart_p_id"),
                        rs.getString("cart_u_id"),
                        rs.getInt("cart_valid") //标记是否已被购买
                );
                list.add(c);
            }
        } catch (SQLException e) {
    ...
    public static int Updatevaild(int id) {
        String sql = "update cart set cart_valid=0 where cart_id=?";
